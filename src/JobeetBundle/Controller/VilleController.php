...
class VilleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $villes = $em->getRepository('JobeetBundle:Ville')->findAll();
    ...
    {
        $ville = new Ville();
        $form = $this->createForm('JobeetBundle\Form\VilleType', $ville);
    ...
    {
        $deleteForm = $this->createDeleteForm($ville);
        $editForm = $this->createForm('JobeetBundle\Form\VilleType', $ville);
