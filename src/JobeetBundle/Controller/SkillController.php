...
class SkillController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $skills = $em->getRepository('JobeetBundle:Skill')->findAll();
    ...
    {
        $skill = new Skill();
        $form = $this->createForm('JobeetBundle\Form\SkillType', $skill);
    ...
    {
        $deleteForm = $this->createDeleteForm($skill);
        $editForm = $this->createForm('JobeetBundle\Form\SkillType', $skill);
